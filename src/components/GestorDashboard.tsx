...
export default function GestorDashboard({
  ...
  const fetchFirebaseConfig = async () => {
    ...
    if (activeConfig) {
      ...
      setFormAuthDomain(activeConfig.authDomain || '');
      setFormProjectId(activeConfig.projectId || '');
      setFormStorageBucket(activeConfig.storageBucket || '');
      setFormMessagingSenderId(activeConfig.messagingSenderId || '');
      setFormAppId(activeConfig.appId || '');
      setFormMeasurementId(activeConfig.measurementId || '');
      setFormFirestoreDatabaseId(activeConfig.firestoreDatabaseId || '(default)');
    }
